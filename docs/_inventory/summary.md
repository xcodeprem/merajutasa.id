...
Generated: 2025-08-21T15:21:13.015Z
Total Files: 152
Scan Directory: `docs/`
...
- **Total Files**: 152
- **Total H1 Headers**: 1055
- **Total H2 Headers**: 1095
- **Average Headers per File**: 14.14
- **Identified Gaps**: 3
...
- **Operations & Runbooks**: 9 files
- **Integrity & Security**: 7 files
- **Status & Progress**: 7 files
- **Planning & Strategy**: 6 files
- **Privacy & Data Protection**: 6 files
- **Reference & Guides**: 6 files
- **Fairness & Equity**: 5 files
- **Analysis & Planning**: 4 files
- **Transparency & Trust**: 4 files
- **Architecture & Analysis**: 3 files
- **Analytics & Events**: 3 files
- **Support & FAQ**: 3 files
...
- `docs/legal/README.md` - Legal — Catatan Yurisdiksi
...
- `docs/privacy/pii-scan-fixture.md` - PII Scan Fixture (Test Only)
- ... and 1 more files
...
- `docs/status/GATE-1-CHECKLIST.md` - Gate 1 – Public Soft Launch Checklist
...
- `docs/architecture/INFRASTRUCTURE-ARCHITECTURE-OVERVIEW.md` - 8/21/2025
- `docs/architecture/LEAD-INFRASTRUCTURE-ARCHITECT-SUMMARY.md` - 8/21/2025
- `docs/archive/fairness_equity-hysteresis-options-v1.md` - 8/21/2025
