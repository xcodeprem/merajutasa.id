...
| disclaimers.presence | ci/lint/disclaimers.js (planned) | Transparency | deny | Existing (TBD) | GP5, GP6, GP7, GP9 | Ensures D1–D7 in required surfaces |
...
| equity.delta.anomaly | analytics/anomaly-detector.js | Fairness Monitoring | observe | DEC-ANOM (planned) | GP9, GP10 | Emits anomaly events |
| principles.reference | ci/lint/principles-reference.js | Governance | deny | DEC-20250812-03 (planned) | GP2 (all) | Ensures Section 37 matrix integrity |
...
No deletions from prior strategy; additions recorded via DEC & manifest.